...
// bot.on('photo', (msg) => {
//     const chatId = msg.chat.id;
//     const photoId = msg.photo[0].file_id; // Get the ID of the first photo in the message
//     const downloadDir = 'C:/Yuvi/Hackathon'; // Replace with your local directory path
